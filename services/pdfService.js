...
async function generateReceiptPDF(data) {
  ...
  const htmlContent = `
    ...
    <head>
      <meta charset="UTF-8">
      <style>
        @import url('https://fonts.googleapis.com/css2?family=Tiro+Devanagari+Marathi&family=Poppins:wght@600;700&display=swap');
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Tiro Devanagari Marathi', serif; }
        ...
        .garland {
          height: 6px;
          background: repeating-linear-gradient(90deg, #ffb703 0, #ffb703 15px, #c1121f 15px, #c1121f 30px);
          border-radius: 4px;
          margin-bottom: 8px;
        }
        ...
        /* ALL 6 FESTIVAL EVENTS BOX (NO SUBTITLES) */
        .events-card {
        ...
        .events-header {
          text-align: center;
          background: linear-gradient(135deg, #003049, #1d2d44);
          color: white;
          padding: 6px;
          border-radius: 8px;
          margin-bottom: 8px;
    ...
    <body>
      <div id="receiptContainer">
        ...
        <!-- ALL 6 FESTIVAL EVENTS BOX (SUBTITLES REMOVED) -->
